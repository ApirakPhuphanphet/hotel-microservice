...
func (x *GetUserToLoginRequest) Reset() {
	*x = GetUserToLoginRequest{}
	mi := &file_userService_proto_userService_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserToLoginRequest) Descriptor() ([]byte, []int) {
	return file_userService_proto_userService_proto_rawDescGZIP(), []int{13}
}
...
func (x *GetUserToLoginResponse) Reset() {
	*x = GetUserToLoginResponse{}
	mi := &file_userService_proto_userService_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserToLoginResponse) Descriptor() ([]byte, []int) {
	return file_userService_proto_userService_proto_rawDescGZIP(), []int{14}
}
...
const file_userService_proto_userService_proto_rawDesc = "" +
	...
	"\x0eGetUserToLogin\x12\x1b.user.GetUserToLoginRequest\x1a\x1c.user.GetUserToLoginResponseB#Z!./userService/proto;userServicepbb\x06proto3"
...
var file_userService_proto_userService_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
